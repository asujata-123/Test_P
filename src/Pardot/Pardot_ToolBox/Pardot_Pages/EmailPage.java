...
public class EmailPage extends GenericPage {
	...
	int x = 0;
	public EmailPage (WebDriver aDriver, String aLOG_FILE) {	
	  ...
	  @FindBy(how = How.CSS, using = "a[class='dropdown-toggle'][id='mark-tog']")
	    ...
	    public WebElement Emails;
		 ...
		 @FindBy(how = How.CSS, using = "i[class='i-icon-open-alt']")
		  ...
		  // Buttons
		  @FindBy(how = How.CSS, using = "div[class='modal-footer'] button[class='btn']")
		    public WebElement CancelButton;
		  
		  @FindBy(how = How.CSS, using = "div[class='modal-footer'] button[class^='btn-primary']")
		    public WebElement ChooseSelectedButton;
		  @FindBy(how = How.CSS, using = "div[class='modal-footer']")
		 ...
		 //Methods
		  ...
		  public void clickCancel() throws IOException, InterruptedException {
			  ...
			  CancelButton.getAttribute("Cancel");
		    	super.clickElement(CancelButton, "Cancel");
		    } 
		  
		//  public WebElement Cancel1 = driver.findElements(By.className('btn'));
		  public void clickChooseSelected() throws IOException, InterruptedException {
		        //super.clickElement(submitButton, "Login Button");
			  ChooseSelectedButton.getAttribute("Choose Selected");
		    	super.clickElement(ChooseSelectedButton,"Choose Selected");
		    } 
